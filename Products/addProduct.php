...
$imgSrc = '../images/image.jpg';
	...
	$sql = "INSERT INTO Product (name, price, imgSrc, description) 
	VALUES('{$_POST['name']}', {$_POST['price']}, '{$imgSrc}', '{$_POST['description']}')";
...
<main>
	<?php
			...
			?>    
         <div class="sabtt">  
  <a class="sabttt" href="../Products/addProduct.html">بازگشت</a>
        </div>  
</main>
 <footer>
